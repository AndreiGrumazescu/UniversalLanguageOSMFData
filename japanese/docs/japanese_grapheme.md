...
| Kanji | `data/kanji/japanese-kanji.schema.json` | `data/kanji/documents/` | Schema only |
...
| Kanji Composition | `data/kanji-composition/japanese-kanji-composition.schema.json` | `data/kanji-composition/documents/` | Schema only |
